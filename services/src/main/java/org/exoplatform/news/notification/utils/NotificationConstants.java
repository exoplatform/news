...
public class NotificationConstants {
  ...
  public static final String POST_NEWS_CONTEXT           = "POST NEWS";

  public static final String SHARE_NEWS_CONTEXT          = "SHARE NEWS";

  public static final String SHARE_MY_NEWS_CONTEXT       = "SHARE MY NEWS";

  public static final String LIKE_MY_NEWS_CONTEXT        = "LIKE MY NEWS";

  public static final String LIKE_MY_SHARED_NEWS_CONTEXT = "LIKE MY SHARED NEWS";
