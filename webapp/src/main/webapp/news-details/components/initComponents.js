import ExoNewsDetails  from './ExoNewsDetails.vue';
import ExoNewsShareActivity  from './ExoNewsShareActivity.vue';
import ExoNewsActivityEditComposer  from './ExoNewsActivityEditComposer.vue';
...
import ExoNewsDetailsActionMenu from './ExoNewsDetailsActionMenu.vue';

Vue.component('exo-news-details', ExoNewsDetails);
Vue.component('exo-news-share-activity', ExoNewsShareActivity);
Vue.component('exo-news-activity-edit-composer', ExoNewsActivityEditComposer);
...
Vue.component('exo-news-details-action-menu', ExoNewsDetailsActionMenu);
