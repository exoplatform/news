...
<template>
  <a
    ...
    <div class="textArea">
      <span class="articlePreTitle">Help & Onboarding</span>
      ...
      <div class="articlePostTitle">
        <span class="articleDate">March 18</span>
        <div class="reactions">
          <i class="likes-icon">
            <svg
